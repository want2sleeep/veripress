...
<template>
    <div class="container">
        <h1 class="reveal-type" style="font-family: ChuangKeJinGang">
            慧析新闻
        </h1>
        <div
            class="text-h4 font-weight-medium mb-2 text-blue-darken-1"
            style="font-family: SiYuanSongTi; margin: 20px"
        >
            AI赋能，慧眼识真，打造值得信赖的新闻鉴别平台
        </div>

        <p
            class="text-h6 mb-4 text-blue-darken-1"
            style="font-family: SiYuanSongTi; margin: 10px"
        >
        ...
        <RouterLink to="/upload">
            <v-btn
                ...
                class="start-button text-h5 font-weight-bold"
                color="yellow-lighten-2"
                size="x-large"
                variant="outlined"
                rounded
                style="font-family: SiYuanSongTi; margin-top: 40px"
            >
                开始检测
            </v-btn>
        </RouterLink>
